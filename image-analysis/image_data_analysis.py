...
# %matplotlib inline
pic = imageio.imread('images/image-data-analysis1.png')
...
pic = imageio.imread('images/image-data-analysis2.jpg') 
plt.figure(figsize=(5,5)) 
plt.imshow(pic) 
plt.show()
# %%
...
# Load the image 
pic = imageio.imread('images/image-data-analysis3.jpg')  
